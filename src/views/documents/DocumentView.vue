  ...
  <div v-else class="custom-mt">
    <div class="card p-2">
      <div class="d-flex justify-content-between align-items-center">
        <div class="m-0">
          <router-link :to="{ name: 'document.dashboard' }" class="btn btn-sm btn-secondary me-1">
        ...
        <div class="card" :style="{ width: '860px' }">
          ...
          <div class="card-body bg-light mail-message-wrapper py-0">
            <div id="mainWrapper" class="mx-auto mb-2" :style="{ width: '815px' }">
              <RenderPDFDoc v-for="doc in sortedFile" :key="doc.id" :file="doc.file_url" @click="$emit('docId', doc.id)"
...
const confirmEdit = () => {
  ...
  setTimeout(() => {
    loading.value = false;
    route.push({ name: "document.dashboard", query: { status: "completed" } });
  }, 1000);
};
